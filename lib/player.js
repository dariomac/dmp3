  ...
  _osPlayer = await osPlayerFactory.init(
    {
      ...
      onDone: async () => {
        ...
        // _playState.fullyPlayedDirs = _bufferingState.fullyPlayedDirs;
        // _playState.playing = _bufferingState.playing;
        // _playState.next = _bufferingState.next;

        // Next was executed onBeforeDone
        await this.play();
      }
    });
}
